/*
Package simulation implements a full fledged Heimdall application used for executing
simulation test suites.

The Heimdall type defines an application used for running extensive simulation
