...
// GetCurrentSyncedCheckpoint is a free data retrieval call binding the contract method 0xd1c407ad.
//
// Solidity: function getCurrentSyncedCheckpoint(uint256 chainId) view returns(uint256)
func (_Stakemanager *StakemanagerCaller) GetCurrentSyncedCheckpoint(opts *bind.CallOpts, chainId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Stakemanager.contract.Call(opts, &out, "getCurrentSyncedCheckpoint", chainId)
...
//
// Solidity: function getCurrentSyncedCheckpoint(uint256 chainId) view returns(uint256)
func (_Stakemanager *StakemanagerSession) GetCurrentSyncedCheckpoint(chainId *big.Int) (*big.Int, error) {
	return _Stakemanager.Contract.GetCurrentSyncedCheckpoint(&_Stakemanager.CallOpts, chainId)
}

// GetCurrentSyncedCheckpoint is a free data retrieval call binding the contract method 0xd1c407ad.
//
// Solidity: function getCurrentSyncedCheckpoint(uint256 chainId) view returns(uint256)
func (_Stakemanager *StakemanagerCallerSession) GetCurrentSyncedCheckpoint(chainId *big.Int) (*big.Int, error) {
	return _Stakemanager.Contract.GetCurrentSyncedCheckpoint(&_Stakemanager.CallOpts, chainId)
}
...
//
// Solidity: function validatorNonce(uint256 validatorId) view returns(uint256)
func (_Stakemanager *StakemanagerCaller) ValidatorNonce(opts *bind.CallOpts, validatorId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Stakemanager.contract.Call(opts, &out, "validatorNonce", validatorId)
...
//
// Solidity: function validatorNonce(uint256 validatorId) view returns(uint256)
func (_Stakemanager *StakemanagerSession) ValidatorNonce(validatorId *big.Int) (*big.Int, error) {
	return _Stakemanager.Contract.ValidatorNonce(&_Stakemanager.CallOpts, validatorId)
}

// ValidatorNonce is a free data retrieval call binding the contract method 0xebde9f93.
//
// Solidity: function validatorNonce(uint256 validatorId) view returns(uint256)
func (_Stakemanager *StakemanagerCallerSession) ValidatorNonce(validatorId *big.Int) (*big.Int, error) {
	return _Stakemanager.Contract.ValidatorNonce(&_Stakemanager.CallOpts, validatorId)
}
...
// SignerUpdate is a paid mutator transaction binding the contract method 0xb3f958b9.
//
// Solidity: function signerUpdate(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactor) SignerUpdate(opts *bind.TransactOpts, data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "signerUpdate", data, sigs)
}

// SignerUpdate is a paid mutator transaction binding the contract method 0xb3f958b9.
//
// Solidity: function signerUpdate(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerSession) SignerUpdate(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.SignerUpdate(&_Stakemanager.TransactOpts, data, sigs)
}

// SignerUpdate is a paid mutator transaction binding the contract method 0xb3f958b9.
//
// Solidity: function signerUpdate(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactorSession) SignerUpdate(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.SignerUpdate(&_Stakemanager.TransactOpts, data, sigs)
}
...
// StakeUpdate is a paid mutator transaction binding the contract method 0xa3175557.
//
// Solidity: function stakeUpdate(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactor) StakeUpdate(opts *bind.TransactOpts, data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "stakeUpdate", data, sigs)
}

// StakeUpdate is a paid mutator transaction binding the contract method 0xa3175557.
//
// Solidity: function stakeUpdate(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerSession) StakeUpdate(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.StakeUpdate(&_Stakemanager.TransactOpts, data, sigs)
}

// StakeUpdate is a paid mutator transaction binding the contract method 0xa3175557.
//
// Solidity: function stakeUpdate(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactorSession) StakeUpdate(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.StakeUpdate(&_Stakemanager.TransactOpts, data, sigs)
}
...
// SubmitCheckpointSync is a paid mutator transaction binding the contract method 0xd2ada573.
//
// Solidity: function submitCheckpointSync(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactor) SubmitCheckpointSync(opts *bind.TransactOpts, data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "submitCheckpointSync", data, sigs)
}

// SubmitCheckpointSync is a paid mutator transaction binding the contract method 0xd2ada573.
//
// Solidity: function submitCheckpointSync(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerSession) SubmitCheckpointSync(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.SubmitCheckpointSync(&_Stakemanager.TransactOpts, data, sigs)
}

// SubmitCheckpointSync is a paid mutator transaction binding the contract method 0xd2ada573.
//
// Solidity: function submitCheckpointSync(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactorSession) SubmitCheckpointSync(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.SubmitCheckpointSync(&_Stakemanager.TransactOpts, data, sigs)
}
...
// ValidatorExit is a paid mutator transaction binding the contract method 0xaa6cdb94.
//
// Solidity: function validatorExit(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactor) ValidatorExit(opts *bind.TransactOpts, data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "validatorExit", data, sigs)
}

// ValidatorExit is a paid mutator transaction binding the contract method 0xaa6cdb94.
//
// Solidity: function validatorExit(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerSession) ValidatorExit(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.ValidatorExit(&_Stakemanager.TransactOpts, data, sigs)
}

// ValidatorExit is a paid mutator transaction binding the contract method 0xaa6cdb94.
//
// Solidity: function validatorExit(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactorSession) ValidatorExit(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.ValidatorExit(&_Stakemanager.TransactOpts, data, sigs)
}

// ValidatorJoin is a paid mutator transaction binding the contract method 0xd1fb3d90.
//
// Solidity: function validatorJoin(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactor) ValidatorJoin(opts *bind.TransactOpts, data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "validatorJoin", data, sigs)
}

// ValidatorJoin is a paid mutator transaction binding the contract method 0xd1fb3d90.
//
// Solidity: function validatorJoin(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerSession) ValidatorJoin(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.ValidatorJoin(&_Stakemanager.TransactOpts, data, sigs)
}

// ValidatorJoin is a paid mutator transaction binding the contract method 0xd1fb3d90.
//
// Solidity: function validatorJoin(bytes data, uint256[3][] sigs) returns()
func (_Stakemanager *StakemanagerTransactorSession) ValidatorJoin(data []byte, sigs [][3]*big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.ValidatorJoin(&_Stakemanager.TransactOpts, data, sigs)
}
