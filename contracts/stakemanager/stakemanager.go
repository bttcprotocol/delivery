...
//
// Solidity: function getCurrentSyncedCheckpoint(uint256 chainId) constant returns(uint256)
...
//
// Solidity: function validatorNonce(uint256 validatorId) constant returns(uint256)
