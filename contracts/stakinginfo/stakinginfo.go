...
// LogStakeAck is a paid mutator transaction binding the contract method 0x50f3cc24.
//
// Solidity: function logStakeAck(uint256 validatorId, uint256 nonce) returns()
func (_Stakinginfo *StakinginfoTransactor) LogStakeAck(opts *bind.TransactOpts, validatorId *big.Int, nonce *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logStakeAck", validatorId, nonce)
}

// LogStakeAck is a paid mutator transaction binding the contract method 0x50f3cc24.
//
// Solidity: function logStakeAck(uint256 validatorId, uint256 nonce) returns()
func (_Stakinginfo *StakinginfoSession) LogStakeAck(validatorId *big.Int, nonce *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStakeAck(&_Stakinginfo.TransactOpts, validatorId, nonce)
}

// LogStakeAck is a paid mutator transaction binding the contract method 0x50f3cc24.
//
// Solidity: function logStakeAck(uint256 validatorId, uint256 nonce) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogStakeAck(validatorId *big.Int, nonce *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStakeAck(&_Stakinginfo.TransactOpts, validatorId, nonce)
}
...
// ValidatorNonceAdd is a paid mutator transaction binding the contract method 0x90889e51.
//
// Solidity: function validatorNonceAdd(uint256 validatorId, uint256 num) returns(uint256)
func (_Stakinginfo *StakinginfoTransactor) ValidatorNonceAdd(opts *bind.TransactOpts, validatorId *big.Int, num *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "validatorNonceAdd", validatorId, num)
}

// ValidatorNonceAdd is a paid mutator transaction binding the contract method 0x90889e51.
//
// Solidity: function validatorNonceAdd(uint256 validatorId, uint256 num) returns(uint256)
func (_Stakinginfo *StakinginfoSession) ValidatorNonceAdd(validatorId *big.Int, num *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.ValidatorNonceAdd(&_Stakinginfo.TransactOpts, validatorId, num)
}

// ValidatorNonceAdd is a paid mutator transaction binding the contract method 0x90889e51.
//
// Solidity: function validatorNonceAdd(uint256 validatorId, uint256 num) returns(uint256)
func (_Stakinginfo *StakinginfoTransactorSession) ValidatorNonceAdd(validatorId *big.Int, num *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.ValidatorNonceAdd(&_Stakinginfo.TransactOpts, validatorId, num)
}

// StakinginfoCheckpointSyncAckIterator is returned from FilterCheckpointSyncAck and is used to iterate over the raw logs and unpacked data for CheckpointSyncAck events raised by the Stakinginfo contract.
type StakinginfoCheckpointSyncAckIterator struct {
	Event *StakinginfoCheckpointSyncAck // Event containing the contract specifics and raw log
...
func (it *StakinginfoCheckpointSyncAckIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakinginfoCheckpointSyncAck)
...
func (it *StakinginfoCheckpointSyncAckIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakinginfoCheckpointSyncAckIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakinginfoCheckpointSyncAck represents a CheckpointSyncAck event raised by the Stakinginfo contract.
type StakinginfoCheckpointSyncAck struct {
...
// FilterCheckpointSyncAck is a free log retrieval operation binding the contract event 0xdfdf269144f74a4d5a4487dae4ae7d89a0764033568a9003b6746591fdbb696c.
//
// Solidity: event CheckpointSyncAck(address indexed proposer, uint256 indexed chainId, uint256 indexed checkpointId, uint256 start, uint256 end)
func (_Stakinginfo *StakinginfoFilterer) FilterCheckpointSyncAck(opts *bind.FilterOpts, proposer []common.Address, chainId []*big.Int, checkpointId []*big.Int) (*StakinginfoCheckpointSyncAckIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "CheckpointSyncAck", proposerRule, chainIdRule, checkpointIdRule)
	if err != nil {
		return nil, err
	}
	return &StakinginfoCheckpointSyncAckIterator{contract: _Stakinginfo.contract, event: "CheckpointSyncAck", logs: logs, sub: sub}, nil
}

// WatchCheckpointSyncAck is a free log subscription operation binding the contract event 0xdfdf269144f74a4d5a4487dae4ae7d89a0764033568a9003b6746591fdbb696c.
//
// Solidity: event CheckpointSyncAck(address indexed proposer, uint256 indexed chainId, uint256 indexed checkpointId, uint256 start, uint256 end)
func (_Stakinginfo *StakinginfoFilterer) WatchCheckpointSyncAck(opts *bind.WatchOpts, sink chan<- *StakinginfoCheckpointSyncAck, proposer []common.Address, chainId []*big.Int, checkpointId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "CheckpointSyncAck", proposerRule, chainIdRule, checkpointIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(StakinginfoCheckpointSyncAck)
				if err := _Stakinginfo.contract.UnpackLog(event, "CheckpointSyncAck", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseCheckpointSyncAck is a log parse operation binding the contract event 0xdfdf269144f74a4d5a4487dae4ae7d89a0764033568a9003b6746591fdbb696c.
//
// Solidity: event CheckpointSyncAck(address indexed proposer, uint256 indexed chainId, uint256 indexed checkpointId, uint256 start, uint256 end)
func (_Stakinginfo *StakinginfoFilterer) ParseCheckpointSyncAck(log types.Log) (*StakinginfoCheckpointSyncAck, error) {
	event := new(StakinginfoCheckpointSyncAck)
	if err := _Stakinginfo.contract.UnpackLog(event, "CheckpointSyncAck", log); err != nil {
		return nil, err
	}
...
// StakinginfoStakeAckIterator is returned from FilterStakeAck and is used to iterate over the raw logs and unpacked data for StakeAck events raised by the Stakinginfo contract.
type StakinginfoStakeAckIterator struct {
	Event *StakinginfoStakeAck // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StakinginfoStakeAckIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakinginfoStakeAck)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StakinginfoStakeAckIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakinginfoStakeAckIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakinginfoStakeAck represents a StakeAck event raised by the Stakinginfo contract.
type StakinginfoStakeAck struct {
	ValidatorId *big.Int
	Nonce       *big.Int
	Raw         types.Log // Blockchain specific contextual infos
}

// FilterStakeAck is a free log retrieval operation binding the contract event 0x4643d2836f85923259a5a998fcadf64a50de43237434716feec3b19ff1d1329b.
//
// Solidity: event StakeAck(uint256 indexed validatorId, uint256 indexed nonce)
func (_Stakinginfo *StakinginfoFilterer) FilterStakeAck(opts *bind.FilterOpts, validatorId []*big.Int, nonce []*big.Int) (*StakinginfoStakeAckIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "StakeAck", validatorIdRule, nonceRule)
	if err != nil {
		return nil, err
	}
	return &StakinginfoStakeAckIterator{contract: _Stakinginfo.contract, event: "StakeAck", logs: logs, sub: sub}, nil
}

// WatchStakeAck is a free log subscription operation binding the contract event 0x4643d2836f85923259a5a998fcadf64a50de43237434716feec3b19ff1d1329b.
//
// Solidity: event StakeAck(uint256 indexed validatorId, uint256 indexed nonce)
func (_Stakinginfo *StakinginfoFilterer) WatchStakeAck(opts *bind.WatchOpts, sink chan<- *StakinginfoStakeAck, validatorId []*big.Int, nonce []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "StakeAck", validatorIdRule, nonceRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StakinginfoStakeAck)
				if err := _Stakinginfo.contract.UnpackLog(event, "StakeAck", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseStakeAck is a log parse operation binding the contract event 0x4643d2836f85923259a5a998fcadf64a50de43237434716feec3b19ff1d1329b.
//
// Solidity: event StakeAck(uint256 indexed validatorId, uint256 indexed nonce)
func (_Stakinginfo *StakinginfoFilterer) ParseStakeAck(log types.Log) (*StakinginfoStakeAck, error) {
	event := new(StakinginfoStakeAck)
	if err := _Stakinginfo.contract.UnpackLog(event, "StakeAck", log); err != nil {
		return nil, err
	}
