...
const (
	...
	DefaultCheckPointerPollInterval time.Duration = 30 * time.Minute // Poll interval for checkpointer service to send new checkpoints or missing ACK
)
...
var (
	...
	KeyCheckPointerPollInterval = []byte("CheckPointerPollInterval")
)
...
type Params struct {
	...
	CheckPointerPollInterval time.Duration `json:"checkpointer_poll_interval" yaml:"checkpointer_poll_interval"`
}
...
func NewParams(
	...
	return Params{
		...
		CheckPointerPollInterval: checkPointerPollInterval,
	}
}
...
func (p *Params) ParamSetPairs() subspace.ParamSetPairs {
	return subspace.ParamSetPairs{
		...
		{KeyCheckPointerPollInterval, &p.CheckPointerPollInterval},
	}
}
...
func (p Params) String() string {
	...
	sb.WriteString(fmt.Sprintf("CheckPointerPollInterval: %s\n", p.CheckPointerPollInterval))
	return sb.String()
}
...
func (p Params) Validate() error {
	...
	if p.CheckPointerPollInterval == 0 {
		return fmt.Errorf("CheckPointerPollInterval should be greater than zero")
	}
